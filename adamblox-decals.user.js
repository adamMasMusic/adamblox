// ==UserScript==
// @name         Adamblox — Decal Uploader
// @namespace    https://github.com/adamMasMusic/adamblox
// @version      2.0
// @description  Batch OpenCloud decal uploader for create.roblox.com
// @author       adamMasMusic
// @match        https://create.roblox.com/*
// @grant        GM_addStyle
// @grant        GM_xmlhttpRequest
// @connect      apis.roblox.com
// @updateURL    https://raw.githubusercontent.com/adamMasMusic/adamblox/main/adamblox-decals.user.js
// @downloadURL  https://raw.githubusercontent.com/adamMasMusic/adamblox/main/adamblox-decals.user.js
// ==/UserScript==
(function () {
  'use strict';
  ...
  function enhanceAssetCards() {
    // Support both old /store/ URL format and newer /creations/ patterns
    const cardSelectors = [
      '[href*="/dashboard/creations/store/"]',
      '[href*="/creations/store/"]',
      'a[href*="/creations/"][href*="/decal"]',
    ];
    const seen = new Set();
    const allCards = cardSelectors.flatMap(sel => [...document.querySelectorAll(sel)]);
    ...
    allCards.forEach((el) => {
      ...
      // Extract asset ID â€” works for /store/12345/ and /creations/12345
